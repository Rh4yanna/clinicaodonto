...
import { ChevronLeft, ChevronRight, MoreVertical, User, Plus } from 'lucide-react';
...
export default function AgendaGeral() {
  ...
  const agendamentosFiltrados = agendamentos.filter(
    (ag) => ag.dia === diaSelecionado.getDate() && ag.mes === diaSelecionado.getMonth()
  );
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto space-y-6 select-none relative min-h-full pb-24">
                    ...
                    {menuAbertoId === item.id && (
                      ...
                      >
                        <button
                          onClick={() => {
                            setMenuAbertoId(null);
                            navigate('/app/recepcao/agenda/reagendar', { state: { pacienteId: item.id } });
                          }}
                        ...
                        <button
                          onClick={() => {
                            setMenuAbertoId(null);
                            navigate('/app/recepcao/agenda/cancelar', { state: { pacienteId: item.id } });
                          }}
