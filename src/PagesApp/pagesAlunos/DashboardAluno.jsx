...
export default function DashboardAluno() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-white font-sans">
      {/* TOPO FIXO - Dashboard */}
      <div className="bg-[#3B42B2] pt-10 pb-6 px-6 text-white flex items-center justify-between shadow-md rounded-b-[24px] shrink-0">
        <button 
      ...
      <div className="flex-1 overflow-y-auto px-5 py-6 space-y-6">
        ...
        <div className="select-none">
          <h2 className="text-slate-900 text-2xl font-extrabold leading-tight">Olá, Rhaya</h2>
        ...
        <div className="grid grid-cols-2 gap-3 select-none">
          ...
          <button 
            ...
            className="bg-white border border-slate-200 hover:border-[#3B42B2]/40 rounded-2xl p-4 text-center shadow-xs transition cursor-pointer active:scale-98"
          >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-xs divide-y divide-slate-100">
            {cirurgiasHoje.map((cirurgia, idx) => (
              ...
              >
                ...
                <div className="pl-2 text-[#3B42B2]"><ChevronRight size={18} /></div>
              </div>
            ))}
          </div>
        </div>
